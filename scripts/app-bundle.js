...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./common/main-menu\"></require><main-menu></main-menu><router-view></router-view></template>"; });
